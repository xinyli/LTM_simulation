...
rule slim_simulate_withsegregating:
  ...
  output:
    prev="PopSize{N}_aL{alphaLarge}_rhot{rhot}_envSD{envSD}_rep{rep}.prev",
    h2="PopSize{N}_aL{alphaLarge}_rhot{rhot}_envSD{envSD}_rep{rep}.h2",
    h2l="PopSize{N}_aL{alphaLarge}_rhot{rhot}_envSD{envSD}_rep{rep}.h2l"
  params:
